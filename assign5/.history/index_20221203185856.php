...
<textarea id=messenger name=messenger cols=40 rows=10>
    ...
    <label for=listen-user>
        ...
        <br> <br>
    <textarea readonly id=listener name=listener cols=40 rows=10>
    </textarea>
...
<script>
    // $("#listen-user").keyup(function(){
    // See: https://makitweb.com/how-to-fire-ajax-request-on-regular-interval/
    function doListen(){
        var listen_user = $("#listen-user").val();
        // console.log(`Listen user: ${listen_user}`);
        $.ajax({
            url: "listen-chat.php",
            type: "POST",
            data: {
    ...
    $(document).ready(function() {
        ...
        // Periodically do the listening
        setInterval(doListen, 100);
    });
</script>